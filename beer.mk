...
# Inherit some common BEER stuff.
$(call inherit-product, vendor/beer/config/common_full_phone.mk)

# Enhanced NFC
$(call inherit-product, vendor/beer/config/nfc_enhanced.mk)
